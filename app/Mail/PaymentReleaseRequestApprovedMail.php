...
class PaymentReleaseRequestApprovedMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $registration_email_content = $emailtemplate[0]->release_request_approved_email;
        ...
        return $this->subject(config('site.title').': Payment Settled')->view('layouts.email', compact('body_content'));
    }
}