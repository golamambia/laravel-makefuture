...
<div class="subbanner_area" style="background-image:url({!! $page[0]->bannerimage && File::exists(public_path('uploads/'.$page[0]->bannerimage))?asset('/uploads/'.$page[0]->bannerimage):asset('/frontend/images/innerbanner1.jpg') !!});">
  <div class="container">
        ...
        <div class="listing_search_box">
          ...
          <div class="d-flex justify-content-start">
            <div class="form-group">
              <input type="text" class="from-control" placeholder="Keyword Search" name="s">
            </div>
            ...
            <div class="form-group">
              <input type="text" class="from-control" placeholder="Collage Name">
            </div>
    ...
    <div class="row">
      <div class="col-lg-3">
         ...
         <nav class='animated bounceInDown'>
            <ul>
              <li><a href='#profile'>10th class</a></li>
              <li class='sub-menu'><a href='#settings'>12th class<div class='fa fa-caret-down right'></div></a>
                <ul>
                  <li><a href='#settings'>arts </a></li>
                  <li><a href='#settings'>science </a></li>
                  <li><a href='#settings'>commerce</a></li>
                </ul>
              </li>
